...
# check all inputs are positive
if price1<=0 or price2<=0 or weight1<=0 or weight2<=0:
    print("negative or zero input is not allowed")
else:
    ...
    elif product2_price_per_gram<product1_price_per_gram:
        print("2nd product is cheaper ",(product1_price_per_gram - product2_price_per_gram))
    else:
        print("both products are same in price")